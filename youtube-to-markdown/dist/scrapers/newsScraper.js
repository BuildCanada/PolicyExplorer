...
exports.processNewsWebsite = processNewsWebsite;
exports.processNewsWebsites = processNewsWebsites;
 ...
 */
function extractLiberalArticles(url_1) {
    return __awaiter(this, arguments, void 0, function* (url, page = 1, cutoffDate) {
        try {
 ...
 */
function extractConservativeArticles(url_1) {
    return __awaiter(this, arguments, void 0, function* (url, page = 1, cutoffDate) {
        try {
 ...
 */
function scrapeArticleContent(article, partyId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(`Scraping article: ${article.url}`);
            const response = yield axios_1.default.get(article.url);
            const html = response.data;
            const $ = cheerio.load(html);
 ...
 */
function saveArticle(article, partyId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Check if we've already processed this URL
            const hasProcessed = yield logRepo.hasBeenProcessed(article.url);
            if (hasProcessed) {
            ...
            if (!article.content) {
                article.content = yield scrapeArticleContent(article, partyId);
            }
            if (!article.content) {
            ...
            const processedChunks = yield (0, embeddingService_1.processTextWithEmbeddings)(article.content);
            // Save embeddings
 ...
 */
function processNewsWebsite(newsPage) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let page = 1; page <= maxPages; page++) {
            ...
            if (newsPage.party_id === 1) { // Liberal
                articles = yield extractLiberalArticles(newsPage.url, page, newsPage.cutoffDate);
            }
            else if (newsPage.party_id === 2) { // Conservative
                articles = yield extractConservativeArticles(newsPage.url, page, newsPage.cutoffDate);
                ...
                if (page === 1) {
                    ...
                    try {
                        const response = yield axios_1.default.get(newsPage.url);
        ...
        for (const article of allArticles) {
            try {
                yield saveArticle(article, newsPage.party_id);
            }
            catch (error) {
